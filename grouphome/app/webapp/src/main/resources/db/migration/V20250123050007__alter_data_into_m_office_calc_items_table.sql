-- Migration script: V20250123050007__alter_data_into_m_office_calc_items_table.sql
...
SET `depends` = '[
    ...
    {"targets": [{"items": ["I", "II", "III", "IV"]}], "action": {"available": {"items": ["VI"], "value": false, "selected": false}}},
